describe('Options', () => {
  ...
  it('Should allow the user to click on the "15m" time menu selection to change the settings of the saved address', () => {
    cy.get('[data-cy="time-menu"]').click()
    cy.get('[data-cy="15m-menu-item"]').click()
  ...
  it('Should allow the user to click on the "30m" time menu selection to change the settings of the saved address', () => {
    cy.get('[data-cy="time-menu"]').click()
    cy.get('[data-cy="30m-menu-item"]').click()
    cy.get('[data-cy="search"]').type("21 Foote Street, Pawcatuck, Connecticut")
    cy.get('[data-cy="submit-search"]').click()
    cy.wait(500)
    cy.get('[data-cy="save"]').click()
  ...
  it('Should allow the user to click on the "45m" time menu selection to change the settings of the saved address', () => {
    cy.get('[data-cy="time-menu"]').click()
    cy.get('[data-cy="45m-menu-item"]').click()
    cy.get('[data-cy="search"]').type("21 Foote Street, Pawcatuck, Connecticut")
    cy.get('[data-cy="submit-search"]').click()
    cy.wait(500)
    cy.get('[data-cy="save"]').click()
  ...
  it('Should allow the user to click on the "60m" time menu selection to change the settings of the saved address', () => {
    cy.get('[data-cy="time-menu"]').click()
    cy.get('[data-cy="60m-menu-item"]').click()
    cy.get('[data-cy="search"]').type("21 Foote Street, Pawcatuck, Connecticut")
    cy.get('[data-cy="submit-search"]').click()
    cy.wait(500)
    cy.get('[data-cy="save"]').click()
